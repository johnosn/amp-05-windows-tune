...
def convert_to_csidl(entry):
    ...
    '''
    # c:\ProgramData
    entry = re.sub('^.:\\\\ProgramData\\\\Microsoft\\\\\Windows\\\\Start Menu\\\\Programs\\\\Startup\\\\', 'CSIDL_COMMON_STARTUP\\\\',
                   entry, flags=re.IGNORECASE)
    entry = re.sub('^.:\\\\ProgramData\\\\Microsoft\\\\\Windows\\\\Start Menu\\\\Programs\\\\', 'CSIDL_COMMON_PROGRAMS\\\\',
                   entry, flags=re.IGNORECASE)
    entry = re.sub('^.:\\\\ProgramData\\\\Microsoft\\\\\Windows\\\\Start Menu\\\\', 'CSIDL_COMMON_STARTMENU\\\\',
                   entry, flags=re.IGNORECASE)
    entry = re.sub('^.:\\\\ProgramData\\\\Microsoft\\\\\Windows\\\\Templates\\\\', 'CSIDL_COMMON_TEMPLATES\\\\',
                   entry, flags=re.IGNORECASE)
    entry = re.sub('^.:\\\\ProgramData\\\\', 'CSIDL_COMMON_APPDATA\\\\',
                   entry, flags=re.IGNORECASE)

    # C:\Program Files (x86)\
    entry = re.sub('^.:\\\\Program Files \\(x86\\)\\\\Common\\\\', 'CSIDL_PROGRAM_FILES_COMMONX86\\\\',
                   entry, flags=re.IGNORECASE)
    entry = re.sub('^.:\\\\Program Files \\(x86\\)\\\\', 'CSIDL_PROGRAM_FILESX86\\\\',
                   entry, flags=re.IGNORECASE)

    # C:\Program Files\
    entry = re.sub('^.:\\\\Program Files\\\\Common', 'CSIDL_PROGRAM_FILES_COMMON\\\\',
                   entry, flags=re.IGNORECASE)
    entry = re.sub('^.:\\\\Program Files\\\\', 'CSIDL_PROGRAM_FILES\\\\',
                   entry, flags=re.IGNORECASE)

    # C:\Users\Public
    entry = re.sub('^.:\\\\Users\\\\Public\\\\Desktop\\\\', 'CSIDL_COMMON_DESKTOPDIRECTORY\\\\',
                   entry, flags=re.IGNORECASE)
    entry = re.sub('^.:\\\\Users\\\\Public\\\\Documents\\\\', 'CSIDL_COMMON_DOCUMENTS\\\\',
                   entry, flags=re.IGNORECASE)
    entry = re.sub('^.:\\\\Users\\\\Public\\\\Favorites\\\\', 'CSIDL_COMMON_FAVORITES\\\\',
                   entry, flags=re.IGNORECASE)
    entry = re.sub('^.:\\\\Users\\\\Public\\\\Music\\\\', 'CSIDL_COMMON_MUSIC\\\\',
                   entry, flags=re.IGNORECASE)
    entry = re.sub('^.:\\\\Users\\\\Public\\\\Pictures\\\\', 'CSIDL_COMMON_PICTURES\\\\',
                   entry, flags=re.IGNORECASE)
    entry = re.sub('^.:\\\\Users\\\\Public\\\\Videos\\\\', 'CSIDL_COMMON_VIDEO\\\\',
                   entry, flags=re.IGNORECASE)

    # C:\Users\Username
    entry = re.sub('^.:\\\\Users\\\\.+?\\\\AppData\\\\Local\\\\Microsoft\\\\Windows\\\\Temporary Internet Files\\\\', 'CSIDL_INTERNET_CACHE\\\\',
                   entry, flags=re.IGNORECASE)
    entry = re.sub('^.:\\\\Users\\\\.+?\\\\AppData\\\\Local\\\\', 'CSIDL_LOCAL_APPDATA\\\\',
                   entry, flags=re.IGNORECASE)
    entry = re.sub('^.:\\\\Users\\\\.+?\\\\AppData\\\\Roaming\\\\Microsoft\\\\Windows\\\\Cookies\\\\', 'CSIDL_COOKIES\\\\',
                   entry, flags=re.IGNORECASE)
    entry = re.sub('^.:\\\\Users\\\\.+?\\\\AppData\\\\Roaming\\\\Microsoft\\\\Windows\\\\Network Shortcuts\\\\', 'CSIDL_NETHOOD\\\\',
                   entry, flags=re.IGNORECASE)
    entry = re.sub('^.:\\\\Users\\\\.+?\\\\AppData\\\\Roaming\\\\Microsoft\\\\Windows\\\\Recent\\\\', 'CSIDL_RECENT\\\\',
                   entry, flags=re.IGNORECASE)
    entry = re.sub('^.:\\\\Users\\\\.+?\\\\AppData\\\\Roaming\\\\Microsoft\\\\Windows\\\\Start Menu\\\\Programs\\\\Startup\\\\', 'CSIDL_STARTUP\\\\',
                   entry, flags=re.IGNORECASE)
    entry = re.sub('^.:\\\\Users\\\\.+?\\\\AppData\\\\Roaming\\\\Microsoft\\\\Windows\\\\Start Menu\\\\Programs\\\\', 'CSIDL_PROGRAMS\\\\',
                   entry, flags=re.IGNORECASE)
    entry = re.sub('^.:\\\\Users\\\\.+?\\\\AppData\\\\Roaming\\\\Microsoft\\\\Windows\\\\Start Menu\\\\', 'CSIDL_STARTMENU\\\\',
                   entry, flags=re.IGNORECASE)
    entry = re.sub('^.:\\\\Users\\\\.+?\\\\AppData\\\\Roaming\\\\Microsoft\\\\Windows\\\\Templates\\\\', 'CSIDL_TEMPLATES\\\\',
                   entry, flags=re.IGNORECASE)
    entry = re.sub('^.:\\\\Users\\\\.+?\\\\AppData\\\\Roaming\\\\', 'CSIDL_APPDATA\\\\',
                   entry, flags=re.IGNORECASE)
    entry = re.sub('^.:\\\\Users\\\\.+?\\\\Desktop\\\\', 'CSIDL_DESKTOPDIRECTORY\\\\',
                   entry, flags=re.IGNORECASE)
    entry = re.sub('^.:\\\\Users\\\\.+?\\\\Documents\\\\', 'CSIDL_MYDOCUMENTS\\\\',
                   entry, flags=re.IGNORECASE)
    entry = re.sub('^.:\\\\Users\\\\.+?\\\\Favorites\\\\', 'CSIDL_FAVORITES\\\\',
                   entry, flags=re.IGNORECASE)
    entry = re.sub('^.:\\\\Users\\\\.+?\\\\Music\\\\', 'CSIDL_MYMUSIC\\\\',
                   entry, flags=re.IGNORECASE)
    entry = re.sub('^.:\\\\Users\\\\.+?\\\\Pictures\\\\', 'CSIDL_MYPICTURES\\\\',
                   entry, flags=re.IGNORECASE)
    entry = re.sub('^.:\\\\Users\\\\.+?\\\\Videos\\\\', 'CSIDL_MYVIDEO\\\\',
                   entry, flags=re.IGNORECASE)
    entry = re.sub('^.:\\\\Users\\\\.+?\\\\', 'CSIDL_PROFILE\\\\',
                   entry, flags=re.IGNORECASE)

    # C:\Windows
    entry = re.sub('^.:\\\\Windows\\\\Fonts\\\\', 'CSIDL_FONTS\\\\',
                   entry, flags=re.IGNORECASE)
    entry = re.sub('^.:\\\\Windows\\\\Resources\\\\', 'CSIDL_RESOURCES\\\\',
                   entry, flags=re.IGNORECASE)
