...
def convert_to_csidl(entry):
    ...
    '''
    # c:\ProgramData
    entry = re.sub(r'^.:\\ProgramData\\Microsoft\\Windows\\Start Menu\\Programs\\Startup\\',
                   r'CSIDL_COMMON_STARTUP\\', entry, flags=re.IGNORECASE)
    entry = re.sub(r'^.:\\ProgramData\\Microsoft\\Windows\\Start Menu\\Programs\\',
                   r'CSIDL_COMMON_PROGRAMS\\', entry, flags=re.IGNORECASE)
    entry = re.sub(r'^.:\\ProgramData\\Microsoft\\Windows\\Start Menu\\',
                   r'CSIDL_COMMON_STARTMENU\\', entry, flags=re.IGNORECASE)
    entry = re.sub(r'^.:\\ProgramData\\Microsoft\\Windows\\Templates\\',
                   r'CSIDL_COMMON_TEMPLATES\\', entry, flags=re.IGNORECASE)
    entry = re.sub(r'^.:\\ProgramData\\',
                   r'CSIDL_COMMON_APPDATA\\', entry, flags=re.IGNORECASE)

    # C:\Program Files (x86)\
    entry = re.sub(r'^.:\\Program Files \(x86\)\\Common\\',
                   r'CSIDL_PROGRAM_FILES_COMMONX86\\', entry, flags=re.IGNORECASE)
    entry = re.sub(r'^.:\\Program Files \(x86\)\\',
                   r'CSIDL_PROGRAM_FILESX86\\', entry, flags=re.IGNORECASE)

    # C:\Program Files\
    entry = re.sub(r'^.:\\Program Files\\Common\\',
                   r'CSIDL_PROGRAM_FILES_COMMON\\', entry, flags=re.IGNORECASE)
    entry = re.sub(r'^.:\\Program Files\\',
                   r'CSIDL_PROGRAM_FILES\\', entry, flags=re.IGNORECASE)

    # C:\Users\Public
    entry = re.sub(r'^.:\\Users\\Public\\Desktop\\',
                   r'CSIDL_COMMON_DESKTOPDIRECTORY\\', entry, flags=re.IGNORECASE)
    entry = re.sub(r'^.:\\Users\\Public\\Documents\\',
                   r'CSIDL_COMMON_DOCUMENTS\\', entry, flags=re.IGNORECASE)
    entry = re.sub(r'^.:\\Users\\Public\\Favorites\\',
                   r'CSIDL_COMMON_FAVORITES\\', entry, flags=re.IGNORECASE)
    entry = re.sub(r'^.:\\Users\\Public\\Music\\',
                   r'CSIDL_COMMON_MUSIC\\', entry, flags=re.IGNORECASE)
    entry = re.sub(r'^.:\\Users\\Public\\Pictures\\',
                   r'CSIDL_COMMON_PICTURES\\', entry, flags=re.IGNORECASE)
    entry = re.sub(r'^.:\\Users\\Public\\Videos\\',
                   r'CSIDL_COMMON_VIDEO\\', entry, flags=re.IGNORECASE)

    # C:\Users\Username
    entry = re.sub(r'^.:\\Users\\.+?\\AppData\\Local\\Microsoft\\Windows\\Temporary Internet Files\\',
                   r'CSIDL_INTERNET_CACHE\\', entry, flags=re.IGNORECASE)
    entry = re.sub(r'^.:\\Users\\.+?\\AppData\\Local\\',
                   r'CSIDL_LOCAL_APPDATA\\', entry, flags=re.IGNORECASE)
    entry = re.sub(r'^.:\\Users\\.+?\\AppData\\Roaming\\Microsoft\\Windows\\Cookies\\',
                   r'CSIDL_COOKIES\\', entry, flags=re.IGNORECASE)
    entry = re.sub(r'^.:\\Users\\.+?\\AppData\\Roaming\\Microsoft\\Windows\\Network Shortcuts\\',
                   r'CSIDL_NETHOOD\\', entry, flags=re.IGNORECASE)
    entry = re.sub(r'^.:\\Users\\.+?\\AppData\\Roaming\\Microsoft\\Windows\\Recent\\',
                   r'CSIDL_RECENT\\', entry, flags=re.IGNORECASE)
    entry = re.sub(r'^.:\\Users\\.+?\\AppData\\Roaming\\Microsoft\\Windows\\Start Menu\\Programs\\Startup\\',
                   r'CSIDL_STARTUP\\', entry, flags=re.IGNORECASE)
    entry = re.sub(r'^.:\\Users\\.+?\\AppData\\Roaming\\Microsoft\\Windows\\Start Menu\\Programs\\',
                   r'CSIDL_PROGRAMS\\', entry, flags=re.IGNORECASE)
    entry = re.sub(r'^.:\\Users\\.+?\\AppData\\Roaming\\Microsoft\\Windows\\Start Menu\\',
                   r'CSIDL_STARTMENU\\', entry, flags=re.IGNORECASE)
    entry = re.sub(r'^.:\\Users\\.+?\\AppData\\Roaming\\Microsoft\\Windows\\Templates\\',
                   r'CSIDL_TEMPLATES\\', entry, flags=re.IGNORECASE)
    entry = re.sub(r'^.:\\Users\\.+?\\AppData\\Roaming\\',
                   r'CSIDL_APPDATA\\', entry, flags=re.IGNORECASE)
    entry = re.sub(r'^.:\\Users\\.+?\\Desktop\\',
                   r'CSIDL_DESKTOPDIRECTORY\\', entry, flags=re.IGNORECASE)
    entry = re.sub(r'^.:\\Users\\.+?\\Documents\\',
                   r'CSIDL_MYDOCUMENTS\\', entry, flags=re.IGNORECASE)
    entry = re.sub(r'^.:\\Users\\.+?\\Favorites\\',
                   r'CSIDL_FAVORITES\\', entry, flags=re.IGNORECASE)
    entry = re.sub(r'^.:\\Users\\.+?\\Music\\',
                   r'CSIDL_MYMUSIC\\', entry, flags=re.IGNORECASE)
    entry = re.sub(r'^.:\\Users\\.+?\\Pictures\\',
                   r'CSIDL_MYPICTURES\\', entry, flags=re.IGNORECASE)
    entry = re.sub(r'^.:\\Users\\.+?\\Videos\\',
                   r'CSIDL_MYVIDEO\\', entry, flags=re.IGNORECASE)
    entry = re.sub(r'^.:\\Users\\.+?\\',
                   r'CSIDL_PROFILE\\', entry, flags=re.IGNORECASE)

    # C:\Windows
    entry = re.sub(r'^.:\\Windows\\Fonts\\',
                   'CSIDL_FONTS\\\\', entry, flags=re.IGNORECASE)
    entry = re.sub(r'^.:\\Windows\\Resources\\',
                   'CSIDL_RESOURCES\\\\', entry, flags=re.IGNORECASE)
    entry = re.sub(r'^.:\\Windows\\System32\\',
                   'CSIDL_SYSTEM\\\\', entry, flags=re.IGNORECASE)
    entry = re.sub(r'^.:\\Windows\\',
                   'CSIDL_WINDOWS\\\\', entry, flags=re.IGNORECASE)
